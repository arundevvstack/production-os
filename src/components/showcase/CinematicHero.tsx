...
export function CinematicHero({ onRunSimulation }: { onRunSimulation: () => void }) {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-zinc-50 dark:bg-zinc-950">
      {/* Background Cinematic Grid */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"></div>
        <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-blue-500/20 dark:bg-blue-500/10 opacity-50 blur-[100px]"></div>
      ...
      <div className="container relative z-10 mx-auto px-4 text-center max-w-4xl">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 mb-8">
            ...
            <span className="text-sm font-medium text-zinc-600 dark:text-zinc-400 tracking-wide uppercase">
          ...
          >
            <Button
              ...
              size="lg"
              className="h-14 px-8 text-lg rounded-full shadow-[0_0_40px_-10px_rgba(59,130,246,0.5)] bg-zinc-900 hover:bg-zinc-800 text-white dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white transition-all duration-300 gap-3 group"
            >
              {isSimulating ? (
                <>
