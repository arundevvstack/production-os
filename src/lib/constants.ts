export const PIPELINE_STAGES = [
  { id: 'new_lead', name: 'New Lead', color: 'bg-secondary' },
  { id: 'contacted', name: 'Contacted', color: 'bg-accent/10' },
  { id: 'discovery_scheduled', name: 'Discovery Scheduled', color: 'bg-accent/10' },
  ...
  { id: 'lost', name: 'Lost', color: 'bg-accent/10' },
];
