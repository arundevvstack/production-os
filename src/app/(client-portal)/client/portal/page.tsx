  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700">
      <header className="flex flex-col gap-2">
        <h1 className="text-3xl font-black text-primary tracking-tight">Welcome back, Client</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 border-none shadow-xl rounded-3xl bg-white border border-border flex flex-col gap-4">
          <div className="flex justify-between items-start">
             <h3 className="font-bold text-primary/80 uppercase tracking-widest text-xs">Active Projects</h3>
        ...
        <Card className="p-6 border-none shadow-xl rounded-3xl bg-white border border-border flex flex-col gap-4">
          <div className="flex justify-between items-start">
             <h3 className="font-bold text-primary/80 uppercase tracking-widest text-xs">Pending Approvals</h3>
        ...
        <Card className="p-6 border-none shadow-xl rounded-3xl bg-white border border-border flex flex-col gap-4">
          <div className="flex justify-between items-start">
             <h3 className="font-bold text-primary/80 uppercase tracking-widest text-xs">Unpaid Invoices</h3>
      ...
      <section className="space-y-4">
        <h3 className="font-bold text-primary uppercase tracking-widest text-sm">Recent Deliverables</h3>
