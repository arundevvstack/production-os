...
export default function PublicEcosystemHomepage() {
  ...
  return (
    <div className="min-h-screen bg-white text-primary font-sans antialiased pb-20 relative overflow-hidden selection:bg-destructive selection:text-white">
      ...
      <header className="border-b border-border/80 bg-white/80 backdrop-blur-xl sticky top-0 z-50">
      ...
      <section className="relative py-32 max-w-[1400px] mx-auto px-6 text-center space-y-10 z-10">
        <div className="max-w-4xl mx-auto space-y-8">
          <Badge className="bg-muted border border-border text-muted-foreground/80 font-bold text-[10px] uppercase tracking-widest px-4 py-1.5 rounded-full shadow-sm">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed font-medium max-w-2xl mx-auto pt-2">
        ...
        <div className="flex justify-center gap-4 pt-6">
          <Link href="/creators/onboarding">
            <Button size="lg" className="bg-destructive hover:bg-destructive text-white font-bold h-14 px-8 rounded-full text-[13px] flex items-center gap-2 shadow-[0_0_25px_rgba(220,38,38,0.25)] hover:shadow-[0_0_35px_rgba(220,38,38,0.35)] hover:-translate-y-0.5 transition-all duration-300">
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        ...
        <Card className="bg-white border border-border rounded-[2rem] hover:border-destructive/30 hover:bg-muted/50 transition-all duration-500 shadow-xl shadow-slate-200/50 overflow-hidden group min-h-[240px] flex flex-col justify-between relative">
          <CardContent className="p-8 space-y-5 relative z-10 flex-1 flex flex-col justify-between">
            <div className="h-12 w-12 bg-destructive/10 rounded-2xl flex items-center justify-center text-destructive ring-1 ring-red-500/20 group-hover:scale-110 transition-transform duration-500">
        ...
        <Card className="bg-white border border-border rounded-[2rem] hover:border-accent/30 hover:bg-muted/50 transition-all duration-500 shadow-xl shadow-slate-200/50 overflow-hidden group min-h-[240px] flex flex-col justify-between relative">
          <CardContent className="p-8 space-y-5 relative z-10 flex-1 flex flex-col justify-between">
            <div className="h-12 w-12 bg-accent/10 rounded-2xl flex items-center justify-center text-accent ring-1 ring-accent/20 group-hover:scale-110 transition-transform duration-500">
        ...
        <Card className="bg-white border border-border rounded-[2rem] hover:border-emerald-500/30 hover:bg-muted/50 transition-all duration-500 shadow-xl shadow-slate-200/50 overflow-hidden group min-h-[240px] flex flex-col justify-between relative">
          <CardContent className="p-8 space-y-5 relative z-10 flex-1 flex flex-col justify-between">
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-20 space-y-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {filteredCreators.map(c => (
            <Card key={c.id} className="bg-white border border-border rounded-3xl overflow-hidden hover:border-destructive/50 hover:shadow-2xl shadow-lg shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between group">
              ...
              <div className="p-8 space-y-6">
                <div className="flex gap-5 items-center">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-destructive font-black uppercase tracking-widest block mt-1.5">{c.category}</span>
                  </div>
                </div>
              ...
              <div className="bg-muted/80 border-t border-border p-5 flex gap-3">
                ...
                <Link href="/talent/login" className="flex-1">
                  <Button className="w-full bg-destructive hover:bg-destructive text-white rounded-full h-12 text-xs font-bold shadow-lg shadow-red-500/20 transition-all">
                    Hire Creator
                  </Button>
                </Link>
              </div>
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-16 relative z-10">
        <Card className="bg-white border border-border rounded-[2.5rem] shadow-2xl shadow-slate-200/50 relative overflow-hidden">
          ...
          <CardContent className="p-12 space-y-8 relative z-10">
            ...
            <form onSubmit={handleAskAssistant} className="flex gap-2 bg-muted p-2 rounded-full border border-border shadow-inner max-w-2xl mx-auto focus-within:border-destructive/50 transition-colors duration-300">
              <Input 
            ...
            {publicAnswer && (
              <div className="p-6 bg-destructive/10 border border-destructive/20 rounded-3xl leading-relaxed text-[13px] text-destructive font-bold animate-in fade-in zoom-in-95 duration-300 max-w-2xl mx-auto shadow-sm">
                {publicAnswer}
              </div>
            )}

            <div className="flex flex-wrap justify-center gap-2 text-[10px] text-muted-foreground font-bold uppercase tracking-widest pt-2">
              <span>Try:</span>
              <button type="button" onClick={() => setPublicQuery("Find Malayalam anchors")} className="hover:text-destructive transition">“Kochi Malayalam Anchors”</button>
              <span>•</span>
              <button type="button" onClick={() => setPublicQuery("What is the cost for AI TVC?")} className="hover:text-destructive transition">“Base AI TVC cost”</button>
            </div>
      ...
      <section id="campaign-generator" className="max-w-[700px] mx-auto px-6 py-16 relative z-10">
        <Card className="bg-white border border-border rounded-[2rem] shadow-xl shadow-slate-200/50">
          <CardContent className="p-10 space-y-6">
            ...
            <form onSubmit={handleLeadSubmit} className="space-y-4 text-left pt-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest block">Campaign Package</label>
                <select 
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest block">Campaign Details / Objective</label>
                <textarea 
                  rows={3}
              ...
              <div className="pt-4">
                <Button 
                  ...
                  className="w-full bg-destructive hover:bg-destructive text-white font-bold h-14 rounded-xl text-[13px] flex items-center justify-center gap-2 shadow-lg shadow-red-500/20 transition-all duration-300 hover:-translate-y-0.5"
                >
      ...
      <footer className="max-w-[1400px] mx-auto px-6 pt-16 mt-10 border-t border-border relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-xs text-muted-foreground/80 font-bold">
          ...
          <div className="col-span-1 md:col-span-1 space-y-4">
            <Logo />
            <p className="text-[11px] leading-relaxed font-bold text-muted-foreground max-w-[200px]">
        ...
        <div className="text-center text-[10px] text-muted-foreground mt-16 pt-8 border-t border-border font-bold uppercase tracking-widest">
