...
export default async function JobDetailPage({ params }: { params: Promise<{ id: string, jobId: string }> }) {
  ...
  if (!job) redirect(`/projects/${resolvedParams.id}/jobs`);
          ...
          <div className="border rounded-xl bg-white p-5 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <div className="font-medium">{(job as any).ProductionAIProvider.name}</div>
              </div>
              <div>
