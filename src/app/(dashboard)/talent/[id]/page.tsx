...
export default function TalentDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-black text-foreground tracking-tight">Talent Profile</h2>
          <p className="text-[11px] text-muted-foreground font-bold uppercase tracking-wider">Media OS Talent Network Roster</p>
        </div>
      </div>

      <ProfileDetailView id={id} sourceRoute="talent" />
    </div>
  );
}
