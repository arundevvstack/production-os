...
export default async function ProductionProjectsPage() {
  const projects = await prisma.project.findMany({
    where: { project_type: "Normal Production" }, // Our seeded type
  ...
  return (
    <div className="p-10 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-10">
        ...
        <button className="bg-black text-white px-4 py-2 rounded-lg font-medium hover:bg-slate-800 transition">
          New Project
        </button>
      </div>
