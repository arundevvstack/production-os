...
export default function ProductionIntelligencePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    async function fetchInsights() {
      try {
        const res = await fetch(`/api/v1/projects/${params.id}/intelligence`);
        ...
        <div className="border rounded-xl bg-white p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="font-bold">{missingItems.references}</div>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm font-medium text-slate-700">
